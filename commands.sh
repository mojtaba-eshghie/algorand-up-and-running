./sandbox goal wallet new walletname
...
./sandbox goal account balance -a address_string
...
# so! finally! 
# go to devnet genesis, find out what the default funded accounts and their wallets are
./sandbox goal account export --address address_from_list_above # to export nmemonic


/opt/testnetwork/Wallet3.rootkey